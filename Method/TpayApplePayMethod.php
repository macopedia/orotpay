...
use Macopedia\Bundle\TpayBundle\Tpay\TpayChannelProvider;
...
class TpayApplePayMethod extends AbstractTpayMethod implements TpayChannelIdInterface
{
    protected const int CHANNEL_ID = 75;
    protected const string METHOD_SUFFIX = 'apple_pay';
    ...
    public function __construct(
        ...
        protected TpayChannelProvider $channelProvider,
    ) {
    }
    ...
    protected function purchase(PaymentTransaction $paymentTransaction): array
    {
        ...
        try {
            $payloadProcessor = $this->payloadFactory->createFrom(PaymentMethod::APPLE_PAY);
    ...
    /**
     * Expose configured gateway for Apple Pay verification method during checkout
     *
     * @return TransactionsApi
     */
    public function getGateway(): object
    {
        return $this->getTransactionsGateway();
    }
