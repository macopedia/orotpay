...
class TpayVisaMobileMethod extends AbstractTpayMethod implements TpayChannelIdInterface
{
    protected const string METHOD_SUFFIX = 'visa_mobile';
    protected const int CHANNEL_ID = 79;
    ...
    protected function purchase(PaymentTransaction $paymentTransaction): array
    {
        ...
        try {
            $payloadProcessor = $this->payloadFactory->createFrom(PaymentMethod::VISA_MOBILE);
